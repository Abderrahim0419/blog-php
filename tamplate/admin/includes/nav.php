...
?>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <li><a href="../index.php">users online:<?php echo user_online();  ?></a></li>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="./categorie.php" data-target="#categorie"><i class="fa fa-fw fa-wrench"></i> Categories</a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#profile"><i class="fa fa-fw fa-arrows-v"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
