                    ...
                    <h6><?php echo $msg; ?></h6>
                        <form role="form" action="" method="post" id="login-form" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="subject" id="key" class="form-control" placeholder="<?php echo password;?>">
                            </div>
                            ...
                            <input type="submit" name="submit" id="btn-login" class="btn btn-custom btn-lg btn-block" value="envoyer">
                        </form>
