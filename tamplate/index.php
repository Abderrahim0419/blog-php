    ...
    <div class="container">
        ...
        ?>
            <?php include "searsh.php";?>
                ...
                <p class="text-right" > <?php echo $post_like; ?> </p>
                        <p class="text-right"><a href="#" id="like" name="like" > <span class="glyphicon glyphicon-thumbs-up"  ></span> Like</a></p>
        ...
        $(document).ready(function (){
            $('#like').click(function () {
                ...
                $.ajax({
                    ...
                    url:"projet/tamplate/index.php?post_id=<?php echo $post_id ;?>",
                    type:'post',
                    data:{
                        'like':1,
                        'post_id':post_id,
